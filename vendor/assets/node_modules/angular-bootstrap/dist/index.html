...
<head>
    ...
    <script src="ui-bootstrap-tpls-0.13.0-SNAPSHOT.min.js"></script>
        ...
        <div class="container">
            ...
            <p>
                ...
                <button type="button" class="btn btn-outline-inverse btn-lg" ng-click="showDownloadModal()">
                    <i class="glyphicon glyphicon-download-alt"></i> Download <small>(0.13.0-SNAPSHOT)</small>
                </button>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <section id="getting_started">
                    ...
                    <ul>
                        <li><a href="http://angularjs.org" target="_blank">AngularJS</a> (requires AngularJS 1.2.x, tested with 1.2.16)</li>
                        <li><a href="http://getbootstrap.com" target="_blank">Bootstrap CSS</a> (tested with version 3.1.1).
                            This version of the library (0.13.0-SNAPSHOT) works only with Bootstrap CSS in version 3.x.
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'accordion')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
...
<p>The presence of the <code>close</code> attribute determines if a close button is displayed</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'alert')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
    ...
    <div class="btn-group">
        ...
        <label class="btn btn-success" ng-model="radioModel" btn-radio="'Right'" uncheckable>Right</label>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'buttons')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
<p>Use a <code>&lt;carousel&gt;</code> element with <code>&lt;slide&gt;</code> elements inside it.  It will automatically cycle through the slides at a given rate, and a current-index variable will be kept in sync with the currently visible slide.</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'carousel')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
  ...
  for (var i=0; i<4; i++) {
	...
	<div collapse="isCollapsed">
		<div class="well well-lg">Some content</div> 
                            ...
                            <div class="col-md-6">
                                <p>AngularJS version of Bootstrap's collapse plugin.
Provides a simple way to hide and show an element with a css transition</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'collapse')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
<li><code>Esc</code>: Will close popup, and move focus to the input.</li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'datepicker')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
There is also the <code>on-toggle(open)</code> optional expression fired when dropdown changes state.</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'dropdown')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
<p>Those methods make it easy to close a modal window without a need to create a dedicated controller.</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'modal')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
&lt;/div&gt;</code></pre>
                                    ...
                                    <tab heading="JavaScript">
                                        <div plunker-content="javascript">
                                            <pre ng-non-bindable><code data-language="javascript">angular.module(&#x27;ui.bootstrap.demo&#x27;).controller(&#x27;ModalDemoCtrl&#x27;, function ($scope, $modal, $log) {
...
angular.module(&#x27;ui.bootstrap.demo&#x27;).controller(&#x27;ModalInstanceCtrl&#x27;, function ($scope, $modalInstance, items) {
  ...
  $scope.cancel = function () {
    $modalInstance.dismiss(&#x27;cancel&#x27;);
                    ...
                    <script>angular.module('ui.bootstrap.demo').controller('ModalDemoCtrl', function ($scope, $modal, $log) {
...
<li><p><code>next-text</code>
 ...
 Text for Next button.</p></li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'pagination')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
$tooltipProvider. See the <a href="#tooltip">tooltip</a> section for more information.</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'popover')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
&lt;/div&gt;
                                    ...
                                    <tab heading="JavaScript">
                                        <div plunker-content="javascript">
                                            <pre ng-non-bindable><code data-language="javascript">angular.module(&#x27;ui.bootstrap.demo&#x27;).controller(&#x27;PopoverDemoCtrl&#x27;, function ($scope) {
  ...
  $scope.dynamicPopoverTitle = &#x27;Title&#x27;;
                    ...
                    <script>angular.module('ui.bootstrap.demo').controller('PopoverDemoCtrl', function ($scope) {
  $scope.dynamicPopover = 'Hello, World!';
  $scope.dynamicPopoverTitle = 'Title';
});
</script>
...
<code>&lt;progress&gt;</code> supports <code>max</code> and <code>animate</code> &amp;  <code>&lt;bar&gt;</code> supports  <code>value</code> and <code>type</code> attributes.</p>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'progressbar')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
<li><p><code>rating-states</code>
 ...
 An array of objects defining properties for all icons. In default template, <code>stateOn</code> &amp; <code>stateOff</code> property is used to specify the icon's class.</p></li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'rating')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
<li><p><code>deselect()</code>
 ...
 An optional expression called when tab is deactivated.</p></li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'tabs')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
 ...
 <em>(Defaults: true)</em> :
  Whether user can scroll inside the hours &amp; minutes input to increase or decrease it's values.</p></li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'timepicker')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
appendToBody: false
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'tooltip')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
...
&lt;/div&gt;
                                    ...
                                    <tab heading="JavaScript">
                                        <div plunker-content="javascript">
                                            <pre ng-non-bindable><code data-language="javascript">angular.module(&#x27;ui.bootstrap.demo&#x27;).controller(&#x27;TooltipDemoCtrl&#x27;, function ($scope) {
  ...
  $scope.htmlTooltip = &#x27;I\&#x27;ve been made &lt;b&gt;bold&lt;/b&gt;!&#x27;;
                    ...
                    <script>angular.module('ui.bootstrap.demo').controller('TooltipDemoCtrl', function ($scope) {
  $scope.dynamicTooltip = 'Hello, World!';
  $scope.dynamicTooltipText = 'dynamic';
  $scope.htmlTooltip = 'I\'ve been made <b>bold</b>!';
});
...
Should the first match automatically be focused as you type?</p></li>
                        ...
                        <div class="row code">
                            <div class="col-md-12" ng-controller="PlunkerCtrl">
                                <div class="pull-right">
                                    <button class="btn btn-info" id="plunk-btn" ng-click="edit('1.2.16', '3.1.1', '0.13.0-SNAPSHOT', 'typeahead')"><i class="glyphicon glyphicon-edit"></i> Edit in plunker</button>
                                </div>
                                <tabset>
                                    <tab heading="Markup">
                                        <div plunker-content="markup">
